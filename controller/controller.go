...
import (
	...
	"encoding/json"
	"net/http"
	cd "remainder_app-master/client_discovery"
	"remainder_app-master/customlogger"
	"remainder_app-master/functions"
	"remainder_app-master/model"
	"remainder_app-master/services"
